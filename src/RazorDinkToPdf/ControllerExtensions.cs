...
public static class ControllerExtensions
{
    ...
    /// <exception cref="RazorPdfGenerationException">Thrown if there is an error locating the view, or generating the PDF content.</exception>
    ...
    /// <exception cref="RazorPdfGenerationException">Thrown if there is an error locating the view, or generating the PDF content.</exception>
    internal static async Task<byte[]> GenerateRazorPdfAsync<TModel>(
        this Controller controller,
        TModel model,
        string? viewName = null,
        GlobalSettings? globalSettings = null,
    ...
    internal static IConverter GetRazorPdfGenerator(
        this Controller controller)
    {
        if (controller is null)
        {
    ...
    internal static async Task<string> RenderViewAsync<TModel>(
        this Controller controller,
        TModel model,
        string? viewName = null,
        bool isPartialView = false)
    ...
    internal static ICompositeViewEngine GetViewEngine(
        this Controller controller)
    {
        if (controller is null)
        {
